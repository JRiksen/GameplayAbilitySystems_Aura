	...
	FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
	...
	const float EffectiveCriticalHitResistance = CriticalHitResistanceCurve->Eval(TargetCombatInterface->GetPlayerLevel());
	
	// Critical Hit Resistance reduces Critical Hit Chance by a certain percentage
	const float EffectiveCriticalHitChance = SourceCriticalHitChance - TargetCriticalHitResistance * EffectiveCriticalHitResistance;
	const bool bCriticalHit{FMath::FRandRange(UE_SMALL_NUMBER, 100.0f) <= EffectiveCriticalHitChance};
